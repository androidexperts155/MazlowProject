...
//    @BindView(R.id.otp_6)
    ...
    private void initilize() {
        ...
        int firstnumber = Integer.parseInt(getphoenumber.substring(8, 9));
        first = String.valueOf(firstnumber);
        int firstsecon = Integer.parseInt(getphoenumber.substring(9, 10));
        secondnum = String.valueOf(firstsecon);
        lastwtodigits.setText(getResources().getString(R.string.entersixdigitscode)+countrycode+"********"+first + secondnum );
